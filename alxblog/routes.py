...
from alxblog import app, db, bcrypt
from alxblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
...
def save_picture(form_picture):
    ...
    pics_path = os.path.join(app.root_path, 'static/profile_pics', pics_file)
